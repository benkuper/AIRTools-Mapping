package org.poly2tri {
	...
	public class Triangle {
		...
		public var indices:Vector.<int> = new Vector.<int>(3, true);
		...
		public function Triangle(p1:Point, p2:Point, p3:Point, fixOrientation:Boolean = false, checkOrientation:Boolean = true, i1:int = 0, i2:int = 0, i3:int = 0) {
			if (fixOrientation) {
